...
<template>
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div
      ...
      class="fixed top-56 md:top-40 left-1/2 z-50 -translate-x-1/2 animate-bounce rounded-none border-2 border-black bg-[#10b981] px-4 py-2 font-mono text-sm font-black text-white shadow-[4px_4px_0_0_black] md:px-6 md:py-3 md:text-lg md:shadow-[5px_5px_0_0_black]"
    >
