...
const algorithms = [
  ...
  },
  {
    ...
    desc: 'In-place comparison sorting algorithm.',
    complexity: 'O(N²)',
  },
  {
  ...
  },
  {
    ...
    img: '/merge-sort.svg',
    desc: 'Divider and conquer algorithm.',
  ...
  },
  {
    ...
    img: '/quick-sort.svg',
    desc: 'Efficient divide and conquer sorting algorithm.',
    complexity: 'O(N log N)',
  },
]
</script>
    ...
    <div class="mx-auto max-w-6xl">
      ...
      <div class="mb-8 border-b-2 border-black pb-4">
        <h1 class="flex items-center gap-3 font-mono text-3xl font-black uppercase">
          <Binary class="h-8 w-8" />
          Sorting_Module
        </h1>
        <p class="mt-2 font-mono text-gray-600">
          > Initialize comparison and non-comparison based sorting visualizations.
        </p>
      </div>
