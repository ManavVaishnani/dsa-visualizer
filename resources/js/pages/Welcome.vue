...
<template>
    ...
    >
        <header
            class="mb-6 w-full max-w-sm text-sm not-has-[nav]:hidden lg:max-w-6xl"
        >
        ...
        >
            <main
                class="flex w-full max-w-sm flex-col-reverse overflow-hidden rounded-lg sm:max-w-2xl lg:max-w-6xl lg:flex-row"
            >
                <div
                    class="flex-1 rounded-br-lg rounded-bl-lg bg-white p-8 pb-12 text-[13px] leading-5 shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-16 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"
                >
                ...
                <div
                    class="relative -mb-px aspect-video w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-1/2 lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]"
                >
                    <svg
                        class="h-full w-full object-cover text-[#F53003] opacity-100 transition-all duration-750 dark:text-[#F61500] starting:translate-y-6 starting:opacity-0"
                        viewBox="0 0 438 104"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
