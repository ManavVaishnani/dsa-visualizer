...
<template>
    <div
        class="relative h-full w-full overflow-hidden border-2 border-black bg-gray-50"
    >
        <svg
            class="h-full w-full"
            viewBox="0 0 800 600"
        ...
        >
            <div
                class="text-center font-mono text-xs font-bold text-gray-500 uppercase md:text-sm"
            >
                Queue
            </div>
        ...
        >
            <div
                class="mb-2 font-mono text-xs font-bold text-black uppercase md:text-sm"
            >
                DFS Stack
            </div>
            ...
            <div
                class="mt-2 text-center font-mono text-[10px] text-gray-500 md:text-xs"
            >
                Top ↑
            </div>
        </div>
        ...
        >
            ...
            <div class="space-y-2">
                <div class="flex items-center gap-2">
                    <div
                        class="size-4 rounded-full border border-black bg-white"
                    ></div>
                    <span class="text-xs text-gray-600 uppercase">Start</span>
                </div>
                <div class="flex items-center gap-2">
                    <div
                        class="size-4 rounded-full border border-black bg-[#6366f1]"
                    ></div>
                    <span class="text-xs text-gray-600 uppercase">Queued</span>
                </div>
                <div class="flex items-center gap-2">
                    <div
                        class="size-4 rounded-full border border-black bg-[#f59e0b]"
                    ></div>
                    <span class="text-xs text-gray-600 uppercase">Active</span>
                </div>
                <div class="flex items-center gap-2">
                    <div
                        class="size-4 rounded-full border border-black bg-[#10b981]"
                    ></div>
