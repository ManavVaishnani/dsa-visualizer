...
<template>
    <div
        class="flex h-full w-full items-center justify-center overflow-hidden bg-gray-50 px-2 md:px-4"
    >
        ...
        >
            <div
                ...
                :key="index"
                class="relative min-w-1 flex-1 border-x border-t border-black transition-all duration-150"
